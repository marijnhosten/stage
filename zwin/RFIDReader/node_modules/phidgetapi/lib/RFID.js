...
function RFID(){
    ...
    function unobserveBoard(callback){
        if(typeof callback != 'function'){
            throw('RFID.unobserveBoard requires a callback function as paramater');
        }
    ...
    function unobserveOutput(callback){
        if(typeof callback != 'function'){
            throw('RFID.unobserveOutputs requires a callback function as paramater');
        }
    ...
    phidget.on('disconnected',function(){
        if(disconnectedHandler)disconnectedHandler();
    });

    phidget.on('detached',function(){
        if(disconnectedHandler)disconnectedHandler();
    });
